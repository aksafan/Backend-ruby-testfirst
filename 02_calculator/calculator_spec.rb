...
describe '#multiply' do
  ...
  it 'multiplies without numbers' do
  ...
  it 'multiplies negative and positive numbers' do
    expect(multiply([2, -2])).to eq(-4)
  end

  it 'multiplies without array' do
    expect { multiply }.to raise_error(ArgumentError, 'wrong number of arguments (given 0, expected 1)')
  end
end
...
describe '#power' do
  ...
  it 'raises zero number to the power of another number' do
    expect(power(0, 3)).to eq(0)
  end

  it 'raises one number to the power of zero number' do
    expect(power(3, 0)).to eq(1)
  end

  it 'raises one number to the power of another negative number' do
    expect(power(2, -3)).to eq(0.125)
  end

  it 'raises one negative number to the power of another number' do
    expect(power(-2, 3)).to eq(-8)
  end

  it 'raises one negative number to the power of another negative number' do
    expect(power(-2, -3)).to eq(-0.125)
  end
end
